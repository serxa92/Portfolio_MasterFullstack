...
export const AboutMe = () => {
  ...
  main.innerHTML = `
      ...
      <section id="about" class = "efecto">
        ...
        <img class = "yo" src="/public/images/Photoroom_20240813_190311.JPEG" alt="Sergio Agulla">
...
Let’s create something awesome!🚀${Button("./public/icons/instagram.png", "Instagram","https://www.instagram.com/sergioagulla/")}</p>
    </section>`;
};
